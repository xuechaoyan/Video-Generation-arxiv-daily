...
> 生成时间：2026-09-07T16:41:51+00:00 · 筛选方式：规则评分（未配置模型 API Key）
...
### 6. [IMPACT: Attention Is the Interaction Map for Scalable Interaction-Aware World Model Training](http://arxiv.org/abs/2609.00161v1)
...
### 7. [Toward Physically Grounded JEPA World Models for Goal-Conditioned Robotic Planning](http://arxiv.org/abs/2609.03565v1)
